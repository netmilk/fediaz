...
class AttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post :create, attachment: { asset: @attachment.asset, name: @attachment.name, weight: @attachment.weight }
    end
  ...
  test "should update attachment" do
    patch :update, id: @attachment, attachment: { asset: @attachment.asset, name: @attachment.name, weight: @attachment.weight }
    assert_redirected_to attachment_path(assigns(:attachment))
  end
