...
class ArtefactsControllerTest < ActionController::TestCase
  ...
  test "should create artefact" do
    assert_difference('Artefact.count') do
      post :create, artefact: { description: @artefact.description, location: @artefact.location, name: @artefact.name, team: @artefact.team, technique: @artefact.technique }
    end
  ...
  test "should update artefact" do
    patch :update, id: @artefact, artefact: { description: @artefact.description, location: @artefact.location, name: @artefact.name, team: @artefact.team, technique: @artefact.technique }
    assert_redirected_to artefact_path(assigns(:artefact))
  end
